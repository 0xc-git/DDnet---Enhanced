...
CHAT_COMMAND("grenadegun", "", CFGFLAG_CHAT, ConGrenadeGun, this, "Shoots a grenade when you shoot gun")

CHAT_COMMAND("rainbow", "?v[id]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConRainbow, this, "Toggles rainbow for player v")
CHAT_COMMAND("member", "?v[id]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConMember, this, "Show all the cmd of Members")
#undef CHAT_COMMAND
